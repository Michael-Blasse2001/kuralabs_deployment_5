...
resource "aws_ecs_task_definition" "aws-ecs-task" {
  ...
  {
      "name": "url-container",
      "image": "michaelblasse/url-shortner:latest",
      "logConfiguration": {
        "logDriver": "awslogs",
        "options": {
  ...
  memory                   = "1024"
  cpu                      = "512"
  execution_role_arn       = "arn:aws:iam::705957968397:role/Deployment_5_ARN"
  task_role_arn            = "arn:aws:iam::705957968397:role/Deployment_5_ARN"
